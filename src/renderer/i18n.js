...
const TRANSLATIONS = {
  ...
  fr: {
    ...
    'settings.ram_hint':           'Recommandé : 4096-8192 MB pour Forge, 2048-4096 MB pour Fabric.',
    'settings.ram_warning_high':   '⚠ Attention — seulement {{left}} MB restants pour le système. Risque de crash ou de freeze.',
    'settings.ram_warning_medium': '⚠ Plus assez de RAM allouée au système ({{left}} MB restants). Risque de lenteurs.',
    ...
    'settings.ram_system':         '(système : {{n}} MB)',
    ...
    'pack.content.sort.alpha_asc':'Nom (A → Z)',
    'pack.content.sort.alpha_desc':'Nom (Z → A)',
    'pack.content.sort.recent':   'Plus récemment ajouté',
    'pack.content.sort.oldest':   'Plus ancien',
    ...
    'pack.content.delete_btn':      'Supprimer ce contenu',
    'pack.content.delete_confirm':  'Supprimer "{{name}}" de cette instance ?',
    'pack.content.delete_done':     'Contenu supprimé',
    'pack.content.updates.refresh': 'Vérifier les updates',
    'pack.content.updates.apply':   'Tout mettre à jour',
    'pack.content.updates.none':    'Aucune mise à jour',
    'pack.content.updates.found':   '{{n}} update(s) disponible(s)',
    'pack.content.updates.done':    '{{n}} mod(s) mis à jour',
    'pack.content.updates.failed':  '{{n}} échec(s)',
    'pack.content.updates.checking':'Vérification...',
    'pack.content.updates.applying':'Mise à jour...',
    'pack.content.updates.badge':   'Update',
    ...
    'pack.settings.ram_warning_high': '⚠ Attention — seulement {{left}} MB restants pour le système. Risque de crash ou de freeze.',
    'pack.settings.ram_warning_medium':'⚠ Plus assez de RAM allouée au système ({{left}} MB restants). Risque de lenteurs.',
    'pack.settings.ram_system':       '(système : {{n}} MB)',
    ...
    'pack.settings.tab.general':      'General',
    'pack.settings.tab.launch':       'Lancement',
    'pack.settings.tab.content':      'Contenu',
    'pack.settings.tab.danger':       'Danger',
    'pack.settings.content_guard':    'Protection du contenu',
    'pack.settings.content_guard_locked': 'Instance verrouillee',
    'pack.settings.content_guard_unlocked': 'Instance deverrouillee',
    'pack.settings.content_guard_locked_hint': 'Cette instance vient d un modpack officiel. Ajouter du contenu peut casser son fonctionnement prevu.',
    'pack.settings.content_guard_unlocked_hint': 'Cette instance accepte maintenant les ajouts de mods, shaders et ressources.',
    'pack.settings.unlock_instance':  'Deverrouiller l instance',
    'pack.settings.unlock_confirm':   'Deverrouiller cette instance ? Vous pourrez ensuite modifier son contenu.',
    'pack.settings.unlock_done':      'Instance deverrouillee',
    'pack.content.locked_error':      'Cette instance est verrouillee (modpack officiel). Deverrouille-la dans les parametres avant d ajouter du contenu.',
    'pack.content.locked_open_settings': 'Ouvrir les parametres',
    ...
    'inst_pick.locked':        'Instance verrouillee',
  ...
  en: {
    ...
    'settings.ram_hint':           'Recommended: 4096-8192 MB for Forge, 2048-4096 MB for Fabric.',
    'settings.ram_warning_high':   '⚠ Warning — only {{left}} MB remaining for the system. Risk of crash or freeze.',
    'settings.ram_warning_medium': '⚠ Not enough RAM left for the system ({{left}} MB remaining). Expect slowdowns.',
    ...
    'settings.ram_system':         '(system: {{n}} MB)',
    ...
    'pack.content.sort.alpha_asc':'Name (A → Z)',
    'pack.content.sort.alpha_desc':'Name (Z → A)',
    'pack.content.sort.recent':   'Most recently added',
    'pack.content.sort.oldest':   'Oldest first',
    'pack.content.filter.config': 'Configs',
    ...
    'pack.content.delete_btn':      'Delete this content',
    'pack.content.delete_confirm':  'Delete "{{name}}" from this instance?',
    'pack.content.delete_done':     'Content deleted',
    'pack.content.updates.refresh': 'Check updates',
    'pack.content.updates.apply':   'Update all',
    'pack.content.updates.none':    'No updates available',
    'pack.content.updates.found':   '{{n}} update(s) available',
    'pack.content.updates.done':    '{{n}} mod(s) updated',
    'pack.content.updates.failed':  '{{n}} failed',
    'pack.content.updates.checking':'Checking...',
    'pack.content.updates.applying':'Updating...',
    'pack.content.updates.badge':   'Update',
    'pack.content.stats.mod':       'Mods',
    'pack.content.stats.shader':    'Shaders',
    ...
    'pack.settings.tab.general':      'General',
    'pack.settings.tab.launch':       'Launch',
    'pack.settings.tab.content':      'Content',
    'pack.settings.tab.danger':       'Danger',
    'pack.settings.content_guard':    'Content protection',
    'pack.settings.content_guard_locked': 'Instance locked',
    'pack.settings.content_guard_unlocked': 'Instance unlocked',
    'pack.settings.content_guard_locked_hint': 'This instance comes from an official modpack. Adding content may break its expected behavior.',
    'pack.settings.content_guard_unlocked_hint': 'This instance now accepts additional mods, shaders, and resource packs.',
    'pack.settings.unlock_instance':  'Unlock instance',
    'pack.settings.unlock_confirm':   'Unlock this instance? You will then be able to modify its content.',
    'pack.settings.unlock_done':      'Instance unlocked',
    'pack.content.locked_error':      'This instance is locked (official modpack). Unlock it in settings before adding content.',
    'pack.content.locked_open_settings': 'Open settings',
    ...
    'pack.settings.ram_warning_high': '⚠ Warning — only {{left}} MB remaining for the system. Risk of crash or freeze.',
    'pack.settings.ram_warning_medium':'⚠ Not enough RAM left for the system ({{left}} MB remaining). Expect slowdowns.',
    'pack.settings.ram_system':       '(system: {{n}} MB)',
    ...
    'inst_pick.locked':        'Locked instance',
